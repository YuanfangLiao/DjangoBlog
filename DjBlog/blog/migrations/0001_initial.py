    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('en_title', models.CharField(max_length=100, null=True, verbose_name='英文标题')),
                ...
                ('author', models.ForeignKey(max_length=100, on_delete=django.db.models.deletion.PROTECT, to='users.UserModel', verbose_name='作者')),
            ],
        ),
        migrations.CreateModel(
            name='CarouselModel',
